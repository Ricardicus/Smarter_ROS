...
private:
  void imageCallback(const sensor_msgs::msg::Image::SharedPtr msg)
  {
    ...
    std::vector<cv::Rect> animals;

    // Detect animals in the image
    cascade_.detectMultiScale(img, animals);
    ...
    sensor_msgs::msg::Image::SharedPtr msg_out = cv_bridge::CvImage(msg->header, "bgra8", img).toImageMsg();
